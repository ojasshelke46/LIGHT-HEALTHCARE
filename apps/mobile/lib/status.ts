/**
 * Appointment status -> badge label + color map (D-22, mirrored for mobile).
 *
 * Classes are NativeWind/Tailwind class strings, applied via `className` on
 * RN primitives (NativeWind v4 supports arbitrary Tailwind utility classes
 * on View/Text).
 */
